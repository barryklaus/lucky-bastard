(() => {
  ...
  $('#again').onclick=()=>location.reload();window.LB3={Game,Rig,ArenaObject,Particle,Confetti,ImpactText,WeaponProjectile,CrowdProjectile,WEAPONS,LOOT,SCENES,POSES,SKINS,COLORS,TRAITS,NAMES,show,pick,rnd,chance,clamp,circle,poly,limb,ctxRoundRect,prepareCanvas};readCreator();requestAnimationFrame(preview);
})();
